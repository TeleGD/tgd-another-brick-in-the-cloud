...
public final class Main {
	...
	public static final void main(String[] arguments) throws SlickException {
		String title = "Another Brick in the Cloud";
		int width = 800;
		int height = 600;
		...
		StateBasedGame game = new StateBasedGame(title) {
			...
			public void initStatesList(GameContainer container) {
				...
				this.addState(new games.anotherBrickInTheCloud.menus.Menu(1));
				this.addState(new pages.Pause(2));
				this.addState(new games.anotherBrickInTheCloud.World(3));
				// this.addState(new games.anotherBrickInTheCloud.menus.GameOver(4));
			}
